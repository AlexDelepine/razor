...
internal static partial class ObjectReaders
{
...
#endif
    {
        ...
        var runtime = (RuntimeKind)reader.ReadInt32OrDefault(nameof(TagHelperDescriptor.Runtime), (int)RuntimeKind.Default);
        ...
        static BoundAttributeParameterDescriptor ReadBoundAttributeParameter(JsonDataReader reader)
        {
            ...
            static BoundAttributeParameterDescriptor ReadFromProperties(JsonDataReader reader)
            {
                ...
                var propertyName = reader.ReadStringOrNull(nameof(BoundAttributeParameterDescriptor.PropertyName));
